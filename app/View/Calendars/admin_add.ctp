<div class="row">
	<div class="col-lg-12">
	    <h1 class="page-header"><?php echo __('Admin Add &raquo; <small>Calendar</small>'); ?></h1>
	</div>
<!-- /.col-lg-12 -->
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<?php echo __('Admin Add &raquo; <small>Calendar</small>'); ?>		<div class="pull-right">
			<div class="btn-group">
        ...
        <div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->Form->input('featured_image', array('type' => 'file', 'label' => 'Featured Image'));?>
				</div>
				<div class="form-group">
