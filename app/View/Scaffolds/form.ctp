...
<div class="row">
	<div class="col-lg-12">
	    <h1 class="page-header"><?php echo Inflector::humanize($singularVar) ?> &raqua; <small><?php echo $action_name  ?></small></h1>
	</div>
<!-- /.col-lg-12 -->
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<?php echo Inflector::humanize($singularVar) ?> &raqua; <small><?php echo $action_name  ?></small>
