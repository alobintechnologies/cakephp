...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><i class="fa fa-list fa-fw"></i> <?php echo $pluralHumanName; ?></h1>
	</div>
</div> <!-- /row -->
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-list fa-fw"></i> <?php echo $pluralHumanName; ?>
			...
			<div class="panel-body">
				...
				<table class="table table-bordered table-hover table-striped" >
					...
					foreach (${$pluralVar} as ${$singularVar}):
					    ...
					    echo $this->Html->link('<span class="fa fa-eye fa-fw"><span>', array('action' => 'view', ${$singularVar}[$modelClass][$primaryKey],), array('escape' => false, 'class' => 'btn btn-default btn-xs'));
					    echo ' ' . $this->Html->link('<span class="fa fa-pencil fa-fw"><span>', array('action' => 'edit', ${$singularVar}[$modelClass][$primaryKey]), array('escape' => false, 'class' => 'btn btn-default btn-xs'));
					    echo ' ' . $this->Form->postLink(
						    '<span class="fa fa-trash-o fa-fw"><span>', array('action' => 'delete', ${$singularVar}[$modelClass][$primaryKey]), array('escape' => false, 'class' => 'btn btn-default btn-xs'), __d('cake', 'Are you sure you want to delete # %s?', ${$singularVar}[$modelClass][$primaryKey])
					    );
					    echo '</nobr></td>';
					    echo '</tr>';
