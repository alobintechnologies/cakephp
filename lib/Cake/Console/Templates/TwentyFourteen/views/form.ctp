...
<div class="row">
	<div class="col-lg-12">
	    <h1 class="page-header"><?php printf("<?php echo __('%s &raquo; <small>%s</small>'); ?>", Inflector::humanize($action), $singularHumanName); ?></h1>
	</div>
<!-- /.col-lg-12 -->
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<?php printf("<?php echo __('%s &raquo; <small>%s</small>'); ?>", Inflector::humanize($action), $singularHumanName); ?>
